package com.example.hcepoc.service
...
class HCEService : HostApduService() {
    ...
    override fun onStartCommand(intent: Intent, flags: Int, startId: Int): Int {
        ...
        Log.e(TAG, "onStartCommand | NDEF$NDEF_URI")
        return Service.START_STICKY
    }
    override fun processCommandApdu(commandApdu: ByteArray, extras: Bundle?): ByteArray {
        Log.e(TAG,"processCommandApdu() | incomingAPDU"+commandApdu.toHex())

        if(Arrays.equals(APDU_SELECT, commandApdu)){
            Log.e(TAG, "APDU_SELECT triggered. 5.5.2 " + A_OKAY.toHex())
            return A_OKAY
        }
